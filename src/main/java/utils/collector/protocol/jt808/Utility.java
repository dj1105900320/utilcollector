...
//		byte [] timeBytes=	{(byte)0x17,(byte)0x29,(byte)0x06,(byte)0x00,(byte)0x00};
//		byte [] timeBytes2=	{(byte)0x17,(byte)0x29,(byte)0x06,(byte)0x00,(byte)0x00};
//		byte[] msms=new byte[2];
//		msms[0]=timeBytes[3];
//		msms[1]=timeBytes[4];
//		byte[] msms2=new byte[2];
//		msms[0]=timeBytes2[3];
//		msms[1]=timeBytes2[4];
//		Date item = null;
//		try {
//			item = format2.parse(format1.format(data)+" "+String.format("%02x", timeBytes[0])
//					   +":"+String.format("%02x", timeBytes[1])
//					   +":"+String.format("%02x", timeBytes[2])
//					   +":"+String.format("%04x", BitConverter.ToUInt16(msms, 0)));
//
//			item = format2.parse(format1.format(data)+" "+String.format("%02d", timeBytes2[0])
//					   +":"+String.format("%02d", timeBytes2[1])
//					   +":"+String.format("%02d", timeBytes2[2])
//					   +":"+String.format("%04d", BitConverter.ToUInt16(msms2, 0)));
//
//
//
